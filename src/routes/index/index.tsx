...
import * as style from '@/routes/style/stlye.scss';
import IndexPage from '@/pages/index';
import LoginPage from '@/pages/Login';

import ColumnChildsComponent from '@/routes/columnChilds/index';
import ColumnItemComponent from '@/routes/cloumnItem/index';
import {IParentContainer} from '@/interfaces/routes.interface';
import ArticleAll from '@/pages/ArticleAll';
import ArticleClass from '@/pages/ArticleClass';
import ArticleTag from '@/pages/ArticleTag';
import Articlepublish from '@/pages/Articlepublish';
import ArticleCreateOrDetail from '@/pages/ArticleCreateOrDetail';
// import ArticleDetail from '@/pages/ArticleDetail'
import {getTagsAll} from '../../action/httpaction';
