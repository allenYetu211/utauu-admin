...
import {IConfigOrigin, IGetParams} from '@/interfaces/http.interface';

type Methods = "get" | "GET" | "delete" | "DELETE" | "head" | "HEAD" | "options" | "OPTIONS" | "post" | "POST" | "put" | "PUT" | "patch" | "PATCH" | undefined
...
class HttpClient {
   ...
   public origin: string;
    ...
    public async AXIOS_REQUEST(method: Methods, param:IGetParams): Promise<any> {
